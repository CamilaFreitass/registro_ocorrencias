...
def lista_classificacao(request):
    url = 'http://reg-oco.camidev.com/api/lista_classificacao'
...
def create_classificacao(request):
    if request.method == 'POST':
        ...
        response = requests.post('http://reg-oco.camidev.com/api/create_classificacao/', data=dados_do_formulario)
...
def create_sistema(request):
    if request.method == 'POST':
        ...
        response = requests.post('http://reg-oco.camidev.com/api/create_sistema/', data=dados_do_formulario)
...
def lista_carteira(request):
    url = 'http://reg-oco.camidev.com/api/lista_carteira'
    params = request.GET.dict()
    response = requests.get(url, params=params)
    data = response.json()
    return render(request, 'listagem.html', data)
...
def create_carteira(request):
    if request.method == 'POST':
        ...
        response = requests.post('http://reg-oco.camidev.com/api/create_carteira/', data=dados_do_formulario)
...
def lista_ocorrencia(request):
    url = 'http://reg-oco.camidev.com/api/lista_ocorrencia'
    params = request.GET.dict()
    response = requests.get(url, params=params)
    data = response.json()
    return render(request, 'listagem.html', data)
...
def create_ocorrencia(request):
    if request.method == 'POST':
        ...
        response = requests.post('http://reg-oco.camidev.com/api/create_ocorrencia/', data=dados_do_formulario)
