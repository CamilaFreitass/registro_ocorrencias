...
from . import views
from .excel import exporta_ocorrencia, exporta_classificacao, exporta_carteira, exporta_sistema
...
urlpatterns = [
    ...
    path('exporta_sistema', exporta_sistema, name='exporta_sistema'),
    ...
    path('exporta_carteira', exporta_carteira, name='exporta_carteira'),
    ...
    path('exporta_classificacao', exporta_classificacao, name='exporta_classificacao'),
    ...
    path('exporta_ocorrencia', exporta_ocorrencia, name='exporta_ocorrencia'),
]
